...
const pract = document.getElementById('practicum')

function makeOne() {
	pract.innerText = 'Привет!'; //Ваш код
}
...
const sp = document.getElementById('practicum2')
function makeTwo() {
	sp.innerText = 'Привет, Мир!';//Ваш код
}
...
const elem = document.getElementById('practicum3');
function makeThree() {
	elem.innerHTML = 'Заголовок изменен!';//Ваш код
}
...
function makeFour() {
	fon.style.backgroundColor = 'red';//Ваш код
}
...
const znach = document.getElementById('practicum5');
function makeFive() {
	znach.textContent = input.value;
}
...
function makeSeven() {
	const a = document.getElementById('practicum7');
	a.href = 'https://www.google.com';
	a.name = 'Ссылка на Google';//Ваш код
}
...
function makeEight() {
	const x = document.getElementById('practicum8');//Найдите элемент x
	const newElement = document.createElement('ul');//Создайте новый пункт списка y
	newElement.textContent = 'Новый элемент';//Добавьте значение в созданный пункт списка y
	x.append(newElement)//Добавьте в список х новый элемент y
}
...
function makeNine() {
	const element=document.getElementById('practicum9');//Найдите элемент
	const newElem = document.createElement('select');//Создайте новый элемент
	newElem.textContent ='Новый вариант';//Добавьте текст в созданный эелемент
	element.append(newElem)//Добавьте новый элемент в выпадающий список
}
...
function makeTen() {
	const color = document.getElementById('practicum10');
	color.style.display = 'none'//Ваш код
}
...
function makeEleven() {
	const pix = document.getElementById('practicum11');
	pix.style.width='400px';//Ваш код
}
...
function makeTwelve() {
	const wihei = document.getElementById('practicum12');
	wihei.style.width = '400px';
	wihei.style.height = '200px';
	wihei.classList.toggle('resizeable');//Ваш код
}
...
function makeThirteen() {
	// const spisok = document.getElementsByTagName('ol')
	// spisok.textContent = 'Первый!';//Ваш код
}
...
function makeFifteen() {
	const practik = document.getElementById('practicum15');
	practik.classList.remove('pr');
	//Ваш код
}
